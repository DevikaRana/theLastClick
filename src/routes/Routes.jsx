...
const CreativePhotography = lazy(() => import("../pages/CreativePhtography"));
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="explore-creative-photography" element={<CreativePhotography />} />
          
          {/* Gallery slider routes */}
